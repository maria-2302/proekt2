...
okno = display.set_mode((1000,1600))
bkgd = transform.scale(image.load('подводный мир.jpg'),(1000,1600))
gm = True
FPS = 80
clock = time.Clock()   
mixer.init()
...
class sprit(sprite.Sprite):
    def __init__(self, imag, x, y,speed):
        super().__init__()
        self.image = transform.scale(image.load(imag),(75,75))
